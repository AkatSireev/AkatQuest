...
public class QuestStateManager {
    ...
    // Загрузка прогресса по квесту для игрока
    ...
    // Сохранение прогресса по квесту для игрока
    ...
    // Обновление состояния следующего квеста, если предыдущий завершён
    ...
    // Получение прогресса по квесту из конфигурации
    ...
    // Создание нового файла игрока, если его нет
    ...
    // Инициализация конфигурации для нового игрока
